...
class PersonalInfoDetailHirarkiCell: UITableViewCell {
    ...
    func setupPersonalInfoDetailHirarki(itemNpp: String, itemRekan: Array<AnyObject>, delegate: DetailPersonalInfoVC, itemNppAtasan: String, itemNamaAtasan: String,
                                        itemUrl: String, itemUrlAtasan: String, itemBawahan: Array<AnyObject>) {
        ...
        hirarkiView.infoDetailBawahan = itemBawahan
